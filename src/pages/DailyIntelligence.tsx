    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-200 rounded-lg p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
          <a href="/deep-dive" className="flex items-center gap-2 text-blue-600 hover:text-blue-800">
            <ExternalLink className="w-4 h-4" />
            Deep Dive Analysis (2000+ words)
          </a>
          <a href="/intelligence-threads" className="flex items-center gap-2 text-purple-600 hover:text-purple-800">
            <ExternalLink className="w-4 h-4" />
            Intelligence Threads (connected stories)
          </a>
          <a href="/ai-tip-tracker" className="flex items-center gap-2 text-green-600 hover:text-green-800">
            <ExternalLink className="w-4 h-4" />
            ...
            {signals.map((signal, idx) => (
              <div key={idx} className="bg-white rounded-lg shadow-md border border-gray-200 p-6 hover:shadow-lg transition-shadow">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                  ...
                  <a href={`/deep-dive?ticker=${signal.ticker}`} className="text-sm text-blue-600 hover:text-blue-800 flex items-center gap-1">
                    Deep Dive Analysis
